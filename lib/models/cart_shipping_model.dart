...
CartShippingModel cartShippingModelFromJson(String str) => CartShippingModel.fromJson(json.decode(str));

String cartShippingModelToJson(CartShippingModel data) => json.encode(data.toJson());

class CartShippingModel {
  CartShippingModel({
    this.data,
    this.meta,
  });
  ...
  factory CartShippingModel.fromJson(Map<String, dynamic> json) => CartShippingModel(
...
class Consignment {
  ...
  factory Consignment.fromJson(Map<String, dynamic> json) => Consignment(
    ...
    availableShippingOptions: List<AvailableShippingOption>.from(json["available_shipping_options"].map((x) => AvailableShippingOption.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "available_shipping_options": List<dynamic>.from(availableShippingOptions!.map((x) => x.toJson())),
  };
}
...
class AvailableShippingOption {
  ...
  factory AvailableShippingOption.fromJson(Map<String, dynamic> json) => AvailableShippingOption(
    id: json["id"],
    type: json["type"],
